...
set CLASSPATH=%APP_HOME%\lib\library-1.0-SNAPSHOT.jar;%APP_HOME%\lib\gson-2.8.6.jar

@rem Execute library
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LIBRARY_OPTS%  -classpath "%CLASSPATH%" library.App %CMD_LINE_ARGS%
